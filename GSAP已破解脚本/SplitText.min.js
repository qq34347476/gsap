...
! function(e) {
    ...
    var t = e.GreenSockGlobals || e,
        ...
        a = function(e) {
            var t = e.nodeType,
                i = "";
            if (1 === t || 9 === t || 11 === t) { if ("string" == typeof e.textContent) return e.textContent; for (e = e.firstChild; e; e = e.nextSibling) i += a(e) } else if (3 === t || 4 === t) return e.nodeValue;
            return i
        },
        h = document,
        p = h.defaultView ? h.defaultView.getComputedStyle : function() {},
        f = /([A-Z])/g,
        u = function(e, t, i, n) { var r; return (i = i || p(e, null)) ? (e = i.getPropertyValue(t.replace(f, "-$1").toLowerCase()), r = e || i.length ? e : i[t]) : e.currentStyle && (i = e.currentStyle, r = i[t]), n ? r : parseInt(r, 10) || 0 },
        c = function(e) { return e.length && e[0] && (e[0].nodeType && e[0].style && !e.nodeType || e[0].length && e[0][0]) ? !0 : !1 },
        g = function(e) {
            var t, i, n, r = [],
                o = e.length;
            for (t = 0; o > t; t++)
        ...
        _ = 127995,
        T = 127999,
        N = function(e) { return (e.charCodeAt(0) - x << 10) + (e.charCodeAt(1) - m) + 65536 },
        ...
        L = function(e, t) {
            ...
            return i && (e = e.split("++").join("")),
                function() { return "<" + t + A + (e ? " class='" + e + (i ? n++ : "") + "'>" : ">") }
        },
        B = n.SplitText = t.SplitText = function(t, i) { if ("string" == typeof t && (t = B.selector(t)), !t) throw "cannot split a null element."; return d ? (this.elements = c(t) ? g(t) : [t], this.chars = [], this.words = [], this.lines = [], this._originals = [], this.vars = i || {}, void this.split(i)) : (e.location.href = "http://" + s + l + "?plugin=" + o + "&source=" + r, !1) },
        O = function(e, t, i) {
            var n = e.nodeType;
            if (1 === n || 9 === n || 11 === n)
        ...
        V = function(e, t) { for (var i = t.length; --i > -1;) e.push(t[i]) },
        W = function(e) {
            var t, i = [],
                n = e.length;
